"""tests/diffdrive/test_diffdrive_package.py -- the DiffDrive package
gate: standalone build + control-law fidelity.

``src/diffdrive/`` is a self-contained differential-drive wheel
...
Run with::
    ...
    uv run python -m pytest tests/diffdrive/ -v -s
"""
...
# tests/diffdrive/test_diffdrive_package.py -> diffdrive -> tests -> root
